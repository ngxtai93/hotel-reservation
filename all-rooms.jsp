														...
														<div class="event-listing-masonry-wrapper">
															<div class="event-listing-masonrys columns-3" style="position: relative; height: 1530px;">
																<article class="masonry-item event-grid">
																	<div class="inner">
																		<div class="post-thumbnails">
																			<a href="single-room-gallery.jsp" title="King Suite Room"><img width="1200" height="1200" src="images/upload/h4.jpg" class="attachment-thumb_330x330 wp-post-image" alt="King Suite Room" /></a>					
																			<div class="info">
																				...
																				<div class="div-read-more"><a class="" href="single-room-gallery.jsp" title="King Suite Room">Detail</a></div>
																			</div>
																		</div>
																	</div>
																</article>
																<article class="masonry-item event-mix-grid">
																	<div class="inner">
																		<div class="post-thumbnails">
																			<a href="single-room-gallery.jsp" title="King Suite Room"><img width="1200" height="1200" src="images/upload/img32.jpg" class="attachment-thumb_330x330 wp-post-image" alt="King Suite Room" /></a>					
																			<div class="info">
																				<div class="product-price">
																					<span class="price">
																					<span class="amount">$&nbsp;1,350</span>							</span>
																...
																<article class="masonry-item event-mix-grid">
																	<div class="inner">
																		<div class="post-thumbnails">
																			<a href="single-room-gallery.jsp" title="King Suite Room"><img width="1200" height="1200" src="images/upload/h2.jpg" class="attachment-thumb_330x330 wp-post-image" alt="King Suite Room"/></a>
																			<div class="info">
																				<div class="product-price">
																					<span class="price">
																				...
																				<div class="div-read-more"><a class="single-room-gallery.jsp" href="single-room-gallery.jsp" title="King Suite Room">Detail</a></div>
																			</div>
																		</div>
																	</div>
																</article>
																<article class="masonry-item event-mix-grid">
																	<div class="inner">
																		<div class="post-thumbnails">
																			<a href="single-room-gallery.jsp" title="King Suite Room"><img width="1200" height="1200" src="images/upload/eiffel.jpg" class="attachment-thumb_330x330 wp-post-image" alt="King Suite Room"></a>					
																			<div class="info">
																				<div class="product-price">
																					<span class="price">
																					<span class="amount">$&nbsp;1,350</span></span>
																...
																<article class="masonry-item event-grid">
																	<div class="inner">
																		<div class="post-thumbnails">
																			<a href="single-room-gallery.jsp" title="King Suite Room"><img width="1200" height="1200" src="images/upload/the-211-best-hotels-in-america.jpg" class="attachment-thumb_330x330 wp-post-image" alt="King Suite Room" /></a>					
																			<div class="info">
																				<div class="product-price">
																					<span class="price">
																					<span class="amount">$&nbsp;1,350</span></span>
					...
					<div class="container k2t-wrap">
						<div class="k2t-main page">
							...
							<div class="pull-right k2t-cal-cols">
								...
								<a href="reservation.jsp" class="k2t-btn-editbooking pull-right">Book Now</a>
							</div>
						</div>
					</div>
				</div>
