				...
				<div class="k2t-wrap">
					<div class="k2t-row">
						...
						<div class="col-8 center">
							...
							<div class="h-element ">		
								<a href="index.jsp" rel="home" class="k2t-logo">
								<h2>CS584</h2>
								</a>
							</div>
							...
							<ul class="h-element k2t-menu " id="menu-menu-2">
								...
								<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1876" id="menu-item-1876">
								<a class="btn-ripple" href="#">
								<span id='logout' class="k2t-title-menu">Logout</span>
								</a>
								</li>
								...
								{ 
									...
									$.post("LoginLogoutManager?action=logout", function(responseText) {     
	
								            if(responseText=="logoutdone") {   
